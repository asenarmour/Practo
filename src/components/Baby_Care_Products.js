...
const Baby_Care_Products = () => {
  ...
  const [item,setItem]=useState([{id:0,name:'',type:'',price:'',description:''}])
  ...
  useEffect(()=>{
    axios.get('/get-medicine-by-type/baby-care').then(response=>{setItem(response.data)})
      .catch(err=>console.log(err));
  },[])
        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-5">
              ...
              {/* <Button onClick={buyMedicine(e)} style={{ margin: "14px" }}>Buy Now</Button> */}
